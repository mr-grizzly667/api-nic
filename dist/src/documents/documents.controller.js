...
let DocumentsController = class DocumentsController {
    ...
    findAll(page = '1', limit = '10', search, category, status) {
...
__decorate([
    ...
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('file', {
        ...
        fileFilter: (req, file, cb) => {
            ...
            if (!allowedMimes.includes(file.mimetype)) {
                return cb(new common_1.BadRequestException('Type de fichier non autorisé (PDF, DOC/X, XLS/X, PPT/X uniquement).'), false);
            }
            cb(null, true);
        },
    })),
    ...
    __metadata("design:paramtypes", [documents_dto_1.CreateDocumentDto, Object, Object]),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, documents_dto_1.UpdateDocumentDto, Object, Object]),
    __metadata("design:returntype", void 0)
